...
- The Rust workspace uses edition 2024 and `rust-version = "1.98.0"`.
- GPUI is pinned in the root `Cargo.toml` to Zed revision `fd82517a115d97a07835b52f0512b22b38e38ccf`.
