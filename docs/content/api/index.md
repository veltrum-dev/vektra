...
- `vektra::Button`、`Checkbox`、`IconButton`、`Tooltip`、能力 traits、主题和共享类型由 Vektra 定义，本站负责解释并提供完整 rustdoc。
...
- 能力 traits：[Clickable](./clickable)、[Focusable](./focusable)、[Disableable](./disableable)、[Sizable](./sizable)
